export default function Test({ setTab, totalQues, fetching, mcqs, qNum, setQNum, chosenOptions, setChosenOptions }) {
  ...
  return (
    mcqs.length > 0 &&
      <div className="container w-[95%] max-w-2xl h-auto min-h-[30rem] flex flex-col items-center justify-center gap-10 p-10 mt-5 mx-auto rounded-lg border bg-light-300 text-secondaryPurple">
